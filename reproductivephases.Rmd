...
![](images/female_phases.png){width=100%}  
Figure 2. Reproductive phases for female *Cephalophilos argus*. Once the individual has moved into the developing phase it is considered mature (all yellow phases). Images from E. Schemmel and more information for this species can be found in [Schemmel et al. 2016](https://drive.google.com/file/d/1wFmlBKoWRPi2OqGiV6wXS1hiCDB-aCdh/view?usp=sharing). 
